...
function onDisconnect(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            (0, typingController_1.removeUserFromTyping)(username, userStopTyping); //Tell front you have stopped typing
            (0, auth_tools_1.removeRefreshToken)({ username });
...
function onUserSendMessage(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, typingController_1.removeUserFromTyping)(event.username, userStopTyping); //Tell front you have stopped typing
    });
}
